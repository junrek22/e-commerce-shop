...
bg[0].style.background = `url(logging-in/slider/`+pics[counter-1]+`)`;
...
function leftButton() {
    ...
    counter--;
    if(counter==0){
        bg[0].style.background = `url(logging-in/slider/`+pics[2]+`)`;
       bg[0].style.backgroundSize = `100% 100%`;
    }else{
        bg[0].style.background = `url(logging-in/slider/`+pics[counter-1]+`)`;
        bg[0].style.backgroundSize = `100% 100%`;
...
function rightButton() {
    ...
    if(counter==car_image.length-1){
        bg[0].style.background = `url(logging-in/slider/`+pics[0]+`)`;
        bg[0].style.backgroundSize = `100% 100%`;
    }else{
        bg[0].style.background = `url(logging-in/slider/`+pics[counter-1]+`)`;
        bg[0].style.backgroundSize = `100% 100%`;
